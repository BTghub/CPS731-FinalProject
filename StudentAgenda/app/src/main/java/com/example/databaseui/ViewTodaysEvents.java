...
public class ViewTodaysEvents extends AppCompatActivity implements EventListAdapter.ListItemClickListener {
    ...
    public void onListItemClick(int position) {
        Intent i = new Intent(ViewTodaysEvents.this, EventDetailsActivity.class);
